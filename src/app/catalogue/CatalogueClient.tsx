...
const STATIC_DRAGONS = [
  {
    ...
    description: "Born from Darkness, feared in every realm. A weapon for dark Souls, shadow warriors, and broken heroes who walk alone on their path.",
    price:       "1,399",
    bg:          "hero-black",
  ...
  },
  {
    ...
    description: "Forged in light, guided by honor. A blade for chosen guardians, protectors of balance, and warriors of destiny.",
    price:       "1,399",
    bg:          "hero-white",
