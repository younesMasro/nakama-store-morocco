...
export default function HomeCollection({ images = {} }: Props) {
  ...
  return (
    <section
      id="catalogue"
      style={{ backgroundColor: "var(--bg)", padding: "clamp(4rem,8vw,7rem) clamp(1.5rem,5vw,4rem)" }}
    >
      {/* Heading */}
      <motion.div
      ...
      >
        ...
        <h2 className="font-heading uppercase" style={{ fontSize: "clamp(2rem,4.5vw,3.8rem)", lineHeight: 0.92, letterSpacing: "0.04em", color: "var(--text)" }}>
          TWO DRAGONS
        </h2>
