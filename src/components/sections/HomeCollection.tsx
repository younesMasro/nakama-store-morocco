...
const DRAGONS = [
  {
    ...
    desc:    "Born from Darkness, feared in every realm. A weapon for dark Souls, shadow warriors, and broken heroes who walk alone on their path.",
    bgKey:   "black",
  ...
  },
  {
    ...
    desc:    "Forged in light, guided by honor. A blade for chosen guardians, protectors of balance, and warriors of destiny.",
    bgKey:   "white",
        ...
        >
          ...
          {showHero && (
            <p style={{ color: "var(--text-muted)", fontSize: "clamp(0.8rem,1.4vw,0.92rem)", lineHeight: 1.65, maxWidth: 520, margin: "1.2rem auto 0" }}>
              Welcome to NAKAMA STORE, Morocco's main destination for premium Katanas, Japanese-inspired collectibles, and exclusive Sword collections.
            </p>
          )}
        </motion.div>
