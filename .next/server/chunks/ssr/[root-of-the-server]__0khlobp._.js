...
`;function f(){try{let b=a.r(22734),c=a.r(14747).join(process.cwd(),".nakama-cache","products.json");if(!b.existsSync(c))return null;let d=JSON.parse(b.readFileSync(c,"utf-8"));if(Date.now()-d.savedAt>18e5)return null;return d.products}catch{return null}}async function g(){try{let b=await c(d,void 0,1800),e=b.products?.nodes??[];return e.length>0&&function(b){try{let c=a.r(22734),d=a.r(14747),e=d.join(process.cwd(),".nakama-cache");c.existsSync(e)||c.mkdirSync(e,{recursive:!0}),c.writeFileSync(d.join(e,"products.json"),JSON.stringify({products:b,savedAt:Date.now()}),"utf-8")}catch(a){console.error("[Nakama] Failed to write product cache:",a)}}(e),e}catch(b){console.error("[Nakama] getProducts() failed.",b);let a=f();if(a)return console.log("[Nakama] Using disk-cached product data."),a;return[]}}async function h(a){try{return(await c(e,{slug:a},1800)).product??null}catch(d){let b=String(d).toLowerCase();if(b.includes("no product id")||b.includes("not found"))return null;console.error(`[Nakama] getProductBySlug("${a}") failed.`,d);let c=f();if(c)return c.find(b=>b.slug===a)??null;return null}}a.s(["formatPrice",0,function(a){if(!a)return null;let b=a?a.replace(/<[^>]*>/g," ").replace(/&nbsp;/g," ").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#039;/g,"'").replace(/\s+/g," ").trim():"",c=b.match(/([\d\s,]+(?:\.\d{1,2})?)/);return c?c[1].replace(/\s/g,"").replace(/\.00$/,"").replace(/,00$/,"").trim():b},"getProductBySlug",0,h,"getProducts",0,g],48983)},25333,a=>{a.v("/_next/static/media/icon.0k8vl_amm57oj.png"+(globalThis.NEXT_CLIENT_ASSET_SUFFIX||""))},21646,a=>{"use strict";let b={src:a.i(25333).default,width:4e3,height:4e3};a.s(["default",0,b])},19941,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/app/checkout/CheckoutClient.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/app/checkout/CheckoutClient.tsx <module evaluation>","default")},41252,a=>{"use strict";a.s(["default",()=>b]);let b=(0,a.i(11857).registerClientReference)(function(){throw Error("Attempted to call the default export of [project]/src/app/checkout/CheckoutClient.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"[project]/src/app/checkout/CheckoutClient.tsx","default")},2758,a=>{"use strict";a.i(19941);var b=a.i(41252);a.n(b)},17122,a=>{"use strict";var b=a.i(7997),c=a.i(48983),d=a.i(2758);async function e({searchParams:a}){let{product:f,qty:g,black:h,white:i}=await a,j=Math.max(1,Math.min(20,parseInt(g??"1",10)||1)),k=a=>null!=a?Math.max(0,Math.min(20,parseInt(a,10)||0)):null,l=k(h),m=k(i),[n,o]=await Promise.all([(0,c.getProductBySlug)("black-dragon"),(0,c.getProductBySlug)("white-dragon")]);return(0,b.jsx)(d.default,{initialSlug:"white-dragon"===f?"white-dragon":"black-dragon"===f?"black-dragon":null,initialQty:j,initialBlackQty:l,initialWhiteQty:m,wcBlack:n,wcWhite:o})}a.s(["default",0,e])},51653,a=>{a.n(a.i(17122))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0khlobp._.js.map